...
if [ "$TRAVIS" == "true" ]; then
    # Workaround for travis-ci/travis-ci#7031 -- remove this entire if block when they fix it.
    DESTINATION="platform=iOS Simulator,OS=10.2,id=22FA2149-1241-469C-BF6D-462D3837DB72"
fi
